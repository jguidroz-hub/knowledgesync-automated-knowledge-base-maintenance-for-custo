...
const FROM = process.env.EMAIL_FROM || 'KnowledgeSync - Automated knowledge base maintenance for customer support teams <noreply@example.com>';
const APP_NAME = 'KnowledgeSync - Automated knowledge base maintenance for customer support teams';
