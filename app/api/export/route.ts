  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="KnowledgeSync - Automated knowledge base maintenance for customer support teams-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
